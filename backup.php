...
$host="localhost";
$bd="fundadeporte";
$nombre="fundadeporte-backup.sql"; //Este es el nombre del archivo a generar
...
if ( empty($tablas) ) {
    $consulta = "SHOW FULL TABLES FROM $bd;";
    $respuesta = mysql_query($consulta, $conexion)
    or die("No se pudo ejecutar la consulta 1: ".mysql_error());
...
foreach ($tablas as $tabla) {
    ...
    $respuesta = mysql_query($consulta, $conexion)
    or die("No se pudo ejecutar la consulta 2: ".mysql_error());
    while ($fila = mysql_fetch_array($respuesta, MYSQL_NUM)) {
    ...
    $respuesta = mysql_query($consulta, $conexion)
    or die("No se pudo ejecutar la consulta 3: ".mysql_error());
